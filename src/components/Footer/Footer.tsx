...
const Footer = () => {
    ...
    const date = new Date();
    const pathToAvoid = ['/dashboard', '/dashboardagent', '/pricing', '/listing', '/singleListing'];
    if (pathToAvoid.includes(location.pathname)) {
        return (
            <>
            </>
        )
                                ...
                                <div className="row">
                                    <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12">
                                        <div className="_housiko_footer_top_img_content">
                                            <Link to="/" className='_housiko_footer_top_img_link'>
                                                <img src="assets/images/ft-logo.svg" alt="" className="_housiko_footer_top_img" />
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    <ul className="_housiko_footer_top_app_btn_ul">
                                        <li className="_housiko_footer_top_app_btn_li">
                                            <button className='_housiko_footer_top_app_btn'>
                                                <img src="assets/images/google.png" alt="play" className='img-fluid _housiko_footer_top_app_btn_img' />
                                            </button>
                                        </li>
                                        <li className="_housiko_footer_top_app_btn_li">
                                            <button className='_housiko_footer_top_app_btn'>
                                                <img src="assets/images/apple.png" alt="app" className='img-fluid _housiko_footer_top_app_btn_img' />
                                            </button>
                                        </li>
                                        <li className="_housiko_footer_top_app_btn_li">
                                            <button className='_housiko_footer_top_qr_btn'>
                                                <img src="assets/images/qr.png" alt="qr" className='img-fluid _housiko_footer_top_qr_img' />
                                            </button>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div className="_housiko_footer_bottom_content">
                                        ...
                                        <ul className="_housiko_footer_bottom_content_ul">
                                            <li className="_housiko_footer_bottom_content_li">
                                                <a href="#0" className="_housiko_footer_bottom_content_link">
                                                    Second hand flats
                                                </a>
                                            </li>
                                            <li className="_housiko_footer_bottom_content_li">
                            ...
                            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div className="_copy_txt_wrap text-center">
                                    <p className='_copy_txt'>
                                        ...
                                        <span className='_copy_txt_yl'> housiko.com</span>. All Rights Reserved <span className='_copy_txt_yl'></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
