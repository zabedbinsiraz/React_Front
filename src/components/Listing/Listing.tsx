...
import { ListingModal } from '../Modals/Modals';
import { ListingCarouselMany, ListingCarouselOne } from './ListingCarousel';
import { ExtraPopover, FavouriteDropdown, PhoneDropdown } from '../Dropdowns/Dropdowns';
...
const Listing = () => {
    ...
    const [mapView] = useSearchParams();
    useEffect(() => {
        let a = mapView.get('tab')
        if (a == 'map') {
            setMapFull(true)
        }
    }, []);
    ...
    return (
        <div className='_housiko_listing_wrapper container-fluid'>
            <div className="_housiko_listing_map_view_btn">
                {
                    listFull &&
                    (
                        <button onClick={() => setListFull(false)} className="_housiko_listing_map_inner_btn _list_btn">
            ...
            <div className="_housiko_listing_container">
                {
                    !listFull && (
                        <div className={`_housiko_listing_map_wrapper _housiko_listing_map_wrap p-0 ${mapFull ? '_housiko_listing_map_full_view' : ''}`}>
                            <div className={`_housiko_listing_map_wrap _housiko_listing_item ${mapFull ? '_housiko_listing_map_full_view' : ''}`}>
                                <div className="_housiko_listing_map_inner_btn_wrap">
                                    <ul className="_housiko_listing_map_inner_btn_ul">
                                        <li className="_housiko_listing_map_inner_btn_li">
                                            <button onClick={() => setListFull(true)} className="_housiko_listing_map_inner_btn">
                                                <SvgIcon iconType={'close'} w={12} h={12} color={'#000'} />
                                            </button>
                                        </li>
                                        <li className="_housiko_listing_map_inner_btn_li">
                                        ...
                                        <li className="_housiko_listing_map_inner_btn_li">
                                            {
                                                !mapFull &&
                                                (
                                                    <button onClick={() => setMapFull(true)} className="_housiko_listing_map_inner_btn _full_view_btn">
                                            ...
                                            }
                                            {
                                                mapFull &&
                                                (
                                                    <button onClick={() => setMapFull(false)} className="_housiko_listing_map_inner_btn _list_btn">
                                    ...
                                    <div className="_housiko_listing_propertymap_card">
                                        <div className="_housiko_listing_propertymap_card_img">
                                            <img src="assets/images/listing-map-card.png" alt="house" className='_housiko_listing_propertymap_card_img_tag' />
                                        </div>
                                        <div className="_housiko_listing_propertymap_card_cont">
                                            <h3 className='_housiko_listing_card_item_content_inner_title'>$25,000</h3>
                                            ...
                                            <ul className='_housiko_listing_propertymap_card_cont_feat'>
                                                <li className='_housiko_listing_propertymap_card_cont_feat_li'>
                                                    <span className="_housiko_listing_card_item_feature_li_ic">
                                                        <SvgIcon iconType={"bed"} color={'#555'} w={20} h={17} />
                                                    </span>
                                                ...
                                                <li className='_housiko_listing_propertymap_card_cont_feat_li'>
                                                    <span className="_housiko_listing_card_item_feature_li_ic">
                                                        <SvgIcon iconType={"bath"} color={'#555'} w={19} h={18} />
                                                    </span>
                                                    <span className="_housiko_listing_card_item_feature_li_txt">
                                                        5
                                                    </span>
                                                ...
                                                <li className='_housiko_listing_propertymap_card_cont_feat_li'>
                                                    <span className="_housiko_listing_card_item_feature_li_ic">
                                                        <SvgIcon iconType={"area"} color={'#555'} w={17} h={18} />
                                                    </span>
                                                    <span className="_housiko_listing_card_item_feature_li_txt">
                                                        3000 Sqft
                                                    </span>
                ...
                {
                    !mapFull && (
                        <div className={`_housiko_listing_wrap _housiko_listing_item ${listFull ? '_housiko_listing_full_view' : ''}`}
                        >
                                ...
                                <div className="_housiko_listing_card_item _housiko_listing_card_item_bl">
                                    ...
                                    <div className="_housiko_listing_card_item_content">
                                        <div className="_housiko_listing_card_item_content_top">
                                            ...
                                            <img src="assets/images/logo-card.svg" alt="logo-card" className="_housiko_listing_card_item_content_img_logo" />
                                        </div>
                                        <div className="_housiko_listing_card_item_content_bottom _housiko_myfav_card_item_content_bottom">
                                            <div className="_housiko_listing_card_item_content_txt">
                                                <div onClick={() => setListModal(true)} className="_housiko_listing_card_item_click" >
                                                    ...
                                                    <div className="_housiko_listing_card_item_desc_wrap">
                                                        <p className="_housiko_listing_card_item_desc_txt">
                                                            Lörem ipsum tasigförsamhet fören elektropol. Lavöpreskapet mining om vusk, i kus. Lörem ipsum tasigförsamhet fören elektropol. Lavöpreskapet mining om vusk, i kus.Lörem ipsum tasigförsamhet fören elektropol. Lavöpreskapet mining om vusk, i kus.
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="_housiko_listing_card_item_bottom_btn_wrap">
                                                    <ul className="_housiko_listing_card_item_bottom_btn_ul _housiko_listing_card_item_bottom_btn_ul3">
                                                        <li className="_housiko_listing_card_item_bottom_btn_li">
                                                            <Link to="" className="_housiko_listing_card_item_bottom_btn _navbar_btn">
                                ...
                                <div className="_housiko_listing_card_item _housiko_listing_card_item_gray">
                                    ...
                                    <div className="_housiko_listing_card_item_content">
                                        <div className="_housiko_listing_card_item_content_top">
                                            ...
                                            <img src="assets/images/elders.svg" alt="logo-card" className="_housiko_listing_card_item_content_img_logo" />
                                        </div>
                                        ...
                                        <div className="_housiko_listing_card_item_content_bottom">
                                            <div className="_housiko_listing_card_item_content_txt">
                                                <div onClick={() => setListModal(true)} className="_housiko_listing_card_item_click">
                                                    ...
                                                    <div className="_housiko_listing_card_item_desc_wrap">
                                                        <p className="_housiko_listing_card_item_desc_txt">
                                                            Lörem ipsum tasigförsamhet fören elektropol. Lavöpreskapet mining om vusk, i kus. Lörem ipsum tasigförsamhet.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="_housiko_listing_card_item_bottom_btn_wrap">
                                ...
                                <div className="_housiko_listing_card_item _housiko_listing_card_item_gray">
                                    ...
                                    <div className="_housiko_listing_card_item_content">
                                        <div className="_housiko_listing_card_item_content_top">
                                            ...
                                            <img src="assets/images/myads-card-txt-ic.svg" alt="logo-card" className="_housiko_listing_hand_logo" />
                                        </div>
                                        <div className="_housiko_listing_card_item_content_bottom">
                                            <div className="_housiko_listing_card_item_content_txt">
                                                <div onClick={() => setListModal(true)} className="_housiko_listing_card_item_click">
