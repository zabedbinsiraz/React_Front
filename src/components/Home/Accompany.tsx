                        ...
                        <div className="row">
                            <div className="col-xl-6 ccol-lg-6 col-md-12 col-sm-12">
                                <div className="_housiko_accompany_content _housiko_accompany_content_yl">
                                    <div className="_housiko_accompany_content_img_wrap">
                                        <img src="assets/images/acc1.png" alt="chobi" className="_housiko_accompany_content_img" />
                                    </div>
                                    <div className="_housiko_accompany_content_txt">
                                        ...
                                        <Link to="/agentlist" className='_housiko_accompany_content_link'>
                                            Find out more, with no string attatch
                                            <span className="_housiko_accompany_content_link_ic">
                                                <SvgIcon iconType={'right-arw'} w={18} h={18} color={'#252E8D'} />
                                            </span>
                                        </Link>
                                    </div>
                                </div>
                            ...
                            <div className="col-xl-6 ccol-lg-6 col-md-12 col-sm-12">
                                <div className="_housiko_accompany_content _housiko_accompany_content_bl">
                                    <div className="_housiko_accompany_content_img_wrap">
                                        <img src="assets/images/acc2.png" alt="chobi" className="_housiko_accompany_content_img" />
                                    </div>
                                    <div className="_housiko_accompany_content_txt">
                                        <h3 className="_housiko_accompany_content_title">
                                        ...
                                        <Link to="/pricing?isLogin=1" className="_housiko_accompany_content_link">
                                            Find out more, with no string attatch
                                            <span className="_housiko_accompany_content_link_ic">
                                                <SvgIcon iconType={'right-arw'} w={18} h={18} color={'#FFBF00'} />
                                            </span>
                                        </Link>
                                    </div>
                                </div>
