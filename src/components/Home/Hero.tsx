...
import { Select, Input, Dropdown, Menu, Button } from 'antd';
import { SvgIcon } from '../Design/SvgIcon';
import { FloorDropdown, PriceDropdown, TotalRoomDropdown, TypeDropdown } from '../Dropdowns/Dropdowns';
                                ...
                                <div className="_housiko_hero_content">
                                    <div className="_housiko_hero_content_txt">
                                        <h1 className="_housiko_hero_content_title">
                                            Your <span className='_housiko_hero_content_title_yl'>
                                                dream <Dropdown overlay={menu} trigger={['click']}>
                                                    <a href='#0' className='_housiko_hero_content_title _housiko_hero_content_title_a _housiko_hero_content_title_yl  d-inline-flex align-items-center'>
                                                        Home
                                                        <span className='d-inline-block mt-1 ms-1' >
                                                            <SvgIcon iconType={'caret-down'} w={12} h={7} color={'#FFBF00'} />
                                                        </span>
                                                    </a>
                                                </Dropdown>
                                            </span> awaits here</h1>
                                    ...
                                    <div className="_housiko_hero_content_tab_wrap">
                                        <ul className="_housiko_hero_content_tab_ul">
                                            <li onClick={() => setIsActive(1)} className={`_housiko_hero_content_tab_li ${isActive == 1 ? '_active' : ''}`}>
                                                Buy
                                            </li>
                                            <li onClick={() => setIsActive(2)} className={`_housiko_hero_content_tab_li ${isActive == 2 ? '_active' : ''}`}>
                                                Rent
                                            </li>
                                        ...
                                        <div className="_housiko_hero_content_tab_content_wrap">
                                            <div className="_housiko_hero_content_tab_content">
                                                ...
                                                <div className="_housiko_hero_content_tab_search_wrap">
                                                    <Button onClick={() => setCityModal(true)} className='_housiko_hero_content_tab_input _housiko_hero_content_tab_input_btn'>
                                                        Find home in town
                                                    </Button>
                                                </div>
                                                ...
                                                <div className="_housiko_hero_content_tab_btn_wrap">
                                                    <div className="_housiko_hero_content_tab_search_btn_wrap d-inline-flex">
                                                        <Link to="/listing" className='_housiko_hero_content_tab_search_btn'>
                                    ...
                                    <div className="_housiko_hero_content_draw_wrap">
                                        ...
                                        <Link to='/listing?tab=map' className='_city_map_btn2'>
                                            <span className='_housiko_hero_content_tab_search_btn_ic'>
