...
import { Checkbox, Image, Input, Modal, Select } from 'antd'
            ...
            <div className="_login_modal_wrapper">
                ...
                >
                    ...
                    <div className="_login_forgot_wrap">
                        ...
                        <a href="#0" className="_login_forgot_link">Forgot password?</a>
                    </div>
                    <div className="_login_submit_wrap">
                        <button className="_login_submit_btn">
                            Submit
                        </button>
                    ...
                    <div className="_login_auth_wrap">
                        <button className="_login_auth_btn">
                            <span className="_login_auth_btn_ic">
                                <img src="assets/images/gg.svg" alt="google" className='_login_auth_btn_ic_img' />
                            </span>
                        ...
                        <button className="_login_auth_btn _fb_btn">
                            <span className="_login_auth_btn_ic">
                                <img src="assets/images/fb.svg" alt="google" className='_login_auth_btn_ic_img' />
                            </span>
                            <span className="_login_auth_btn_txt">
                        ...
                        <button className="_login_auth_btn _login_auth_apl_btn">
                            <span className="_login_auth_btn_ic">
                                <img src="assets/images/apl.svg" alt="apple" className='_login_auth_btn_ic_img' />
                            </span>
                            <span className="_login_auth_btn_txt">
                                Continue with Apple
                            </span>
    ...
    return (
        <>
            ...
            >
                ...
                <div className="_login_submit_wrap">
                    <button onClick={() => navigateTo('pricing')} className="_login_submit_btn">
                        Create my account
                    </button>
                </div>
                <div className="_login_or_wrap">
        ...
        <div className="_login_modal_wrapper _city_modal_wrapper">
            <Modal
                ...
                footer={[
                    ...
                    <button className='_city_modal_btn _city_modal_apply_btn'>Apply</button>
                ]}
                closeIcon={<SvgIcon iconType={'close'} w={14} h={14} />}
                width={648}
            >
                <Input placeholder="e.g : District V or szeged orz street" className='_city_input' />
                <div className="_city_map_btn_wrap _city_map_btns">
                    <button className="_city_map_btn">
                        ...
                        <span className="_city_map_btn_txt">
                            Draw On Map
                        </span>
                    </button>
                    <button onClick={() => setSavedSearchModal(true)} className="_city_map_btn">
                        <span className="_city_map_btn_txt">
                            My saved searches
                        </span>
                    </button>
                ...
                <div className="_city_map_tab_wrap">
                    <ul className="_city_map_tab_ul">
                        <li className="_city_map_tab_li _active">
                            Budapest
                        </li>
                        <li className="_city_map_tab_li">
                            Balaton
                        </li>
                        <li className="_city_map_tab_li">
                            Other cities
                    ...
                    <div className="_city_map_tab_content">
                        <div className="_city_map_tab_content_inner">
                            <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                <Input type="checkbox" id="all" className='_login_input_check _city_input_check_login_input_check' />
                                <label className='_login_input_label' htmlFor="all">All</label>
                            </div>
                            <div className="_city_map_tab_content_ul_wrap">
                                <ul className="_city_map_tab_content_ul">
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">I.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">II.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">III.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">IV.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">V.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">VI.</label>
                                        </div>
                                    </li>
                                </ul>
                                <ul className="_city_map_tab_content_ul">
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">VII.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">VIII.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">IX.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">X.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XI.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XII.</label>
                                        </div>
                                    </li>
                                </ul>
                                <ul className="_city_map_tab_content_ul">
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XIII.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XIV.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XV.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XVI.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XVII.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XVIII.</label>
                                        </div>
                                    </li>
                                </ul>
                                <ul className="_city_map_tab_content_ul">
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XIX.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XX.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XXI.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XXII.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XXIII.</label>
                                        </div>
                                    </li>
                                    <li className="_city_map_tab_content_li">
                                        <div className="_city_map_tab_content_all_wrap _login_remember_check">
                                            <Input type="checkbox" className='_city_input_check _login_input_check' />
                                            <label className='_city_input_label ' htmlFor="">XXIV.</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
            ...
            <SavedSearch open={savedSearchModal} cancel={() => setSavedSearchModal(false)} />
        </div >
    )
}
                    ...
                    <div className="_city_map_tab_wrap border-bottom-0 m-0">
                        <div className="_housiko_list_prop_characterstics _housiko_list_prop_characterstics_big_input_wrap m-0">
                            <div className="_housiko_list_prop_characterstics_input_wrap mt-0">
                                <label htmlFor="" className='_housiko_list_prop_characterstics_label'>Bedrooms</label>
                            ...
                            <div className="_housiko_list_prop_characterstics_input_wrap">
                                <label htmlFor="" className='_housiko_list_prop_characterstics_label'>Bathroom</label>
                                <div className="_housiko_list_prop_characterstics_input_inner">
                                    <ul className="_housiko_list_prop_tab_ul _housiko_list_prop_tab_ul3">
                                        <li className="_housiko_list_prop_tab_li  _active">
                                            All
                            ...
                            <div className="_housiko_list_prop_characterstics_input_wrap">
                                <label htmlFor="" className='_housiko_list_prop_characterstics_label'>Floor</label>
                                ...
                                <div className="_housiko_list_prop_feature_wrap">
                                    <div className="_housiko_list_prop_feature_inner">
                                        ...
                                        <div className="_housiko_list_prop_feature_content">
                                            <h3 className="_housiko_list_prop_feature_content_title">Orientation</h3>
                                            <div className="_housiko_list_prop_feature_check_wrap">
                                                <div className="_housiko_list_prop_feature_check _city_map_tab_content_all_wrap _login_remember_check">
                                                    <Checkbox className='_login_input_check _city_input_check_login_input_check _login_input_label'>
                                                        North
                                        ...
                                        <div className="_housiko_list_prop_feature_content">
                                            <h3 className="_housiko_list_prop_feature_content_title">Languages spoken</h3>
                                    ...
                                    <div className="_housiko_list_prop_feature_inner _housiko_list_prop_feature_inner2">
                                        <div className="_housiko_list_prop_feature_content">
                                            <h3 className="_housiko_list_prop_feature_content_title">Conservation status</h3>
                                            <div className="_housiko_list_prop_feature_check_wrap">
                                                <div className="_housiko_list_prop_feature_check _city_map_tab_content_all_wrap _login_remember_check">
                                                    <Checkbox className='_login_input_check _city_input_check_login_input_check _login_input_label'>
                                                        Almost New
                                        ...
                                        <div className="_housiko_list_prop_feature_content">
                                            <h3 className="_housiko_list_prop_feature_content_title">Extras</h3>
                                        ...
                                        <div className="_housiko_list_prop_feature_content">
                                            <h3 className="_housiko_list_prop_feature_content_title">Others</h3>
                                            <div className="_housiko_list_prop_feature_check_wrap d-flex">
                                                <div className="_housiko_list_prop_feature_check _city_map_tab_content_all_wrap _login_remember_check">
                                                    <Checkbox className='_login_input_check _city_input_check_login_input_check _login_input_label'>
                                                        On sale
            ...
            <div className="_login_modal_wrapper _alert_modal_wrapper">
                ...
                >
                    ...
                    <div className="_alert_modal_illustration">
                        <img src="assets/images/alert-Modal-illustration.png" alt="alert-illustration" className='_alert_modal_illustration_img' />
                    </div>
                    <div className="_alert_modal_content">
                        <h5 className='_alert_modal_content_txt'>You have created an alert with the
                            following filters:</h5>
                        <p className='_alert_modal_content_para'>Type, price, floor area, rooms</p>
                    </div>
                </Modal>
            </div>
        </>
        ...
        <>
            <div className="_login_modal_wrapper _alert_modal_wrapper">
                ...
                >
                    ...
                    <div className="_alert_modal_illustration">
                        <img src="assets/images/search.svg" alt="alert-illustration" className='_alert_modal_illustration_img' />
                    </div>
                    <div className="_alert_modal_content">
                        <h5 className='_alert_modal_content_txt'>You have saved a search with the following filters:</h5>
                        <p className='_alert_modal_content_para'>Type, price, floor area, rooms</p>
                    </div>
                </Modal>
            </div>
        ...
        <div className="_login_modal_wrapper _report_modal_wrapper">
            ...
            >
                ...
                <div className="_report_modal_buttons">
                    <button className='_report_modal_button'>
                        Send Report
                    </button>
                </div>
            </Modal>
...
export const EditInfoModal = ({ open, cancel, name, email, updateName, updateEmail }: any) => {
    ...
    return (
        <>
            ...
            >
                <div className='mt-4'>
                    <h5 className='_alert_modal_content_txt fs-5'>
                        Update Name
                    </h5>
        ...
        <>
            ...
            >
                <div className='_housiko_image_lightbox_wrap'>
                    <ReactImageGallery startIndex={startIndex} items={imageList} showPlayButton={false} showIndex={true} />
                </div>
            </Modal>
        </>
    )
                    ...
                    <ul className="_saved_modal_content_ul">
                        <li className="_saved_modal_content_li">
                            <div className="_saved_modal_content_li_txt">
                                ...
                                <p className="_saved_modal_content_li_p">
                                    Buy, Home
                                </p>
                            </div>
