...
const SingleListing = () => {
    ...
    return (
        <div className={`_listing_modal_inner ${location.pathname === '/singleListing' ? '_singleListing_page_wrap' : ''}`}>
            <div className="_listing_modal_img_wrap">
                <div className="_listing_modal_top_img_wrap">
                    <button className="_listing_modal_top_btn">
                        Virtual 3D tour
                    </button>
                    <img src="assets/images/listing-img.png" alt="" className='_listing_modal_top_img img-fluid' />
                </div>
                <LightBox startIndex={selectedImg} imageList={images} open={isLightboxOn} cancel={() => { setLightboxOn(false) }} />
                <div className="_listing_modal_bottom_img_ul_wrap">
                    <ul className="_listing_modal_bottom_img_ul">
                        {
                            images.map((img, id) => {
                                return (
                                    <li onClick={() => setSelectedImg(id)} className="_listing_modal_bottom_img_li">
                                        <img src={img.original} alt="" className="_listing_modal_bottom_img" onClick={() => setLightboxOn(true)} />
                                    </li>
                                )
                            })
                        }
                ...
                <div className="_listing_modal_content_txt">
                    <div className="_listing_modal_card_inner">
                        <div className="_listing_modal_card_inner_btn">
                            ...
                            <div className="_listing_modal_card_inner_btn_list">
                                <button className='_housiko_listing_modal_card_item_btn' onClick={showCreateReportModal}>
                                    <span className="_housiko_listing_card_item_bottom_btn_ic">
                                        <SvgIcon iconType={'info'} color={'#555555'} w={20} h={20} />
                                    </span>
                                    <span className='_housiko_listing_card_item_bottom_btn_txt _del_modal_btn_txt'>
                                        Report error
                                    </span>
                        ...
                        <div className="_listing_modal_card_inner_btn inner_btns">
                            ...
                            {
                                location.pathname != '/singleListing' && (
                                    <Link to="/singleListing" target="_blank" className='_housiko_listing_modal_card_item_btn'>
                                        <span className="_housiko_listing_card_item_bottom_btn_ic">
                    ...
                    <div className="_listing_modal_card_rent_conts">
                        ...
                        <div className='_listing_modal_card_rent_chat _housiko_listing_card_item_bottom_btn_li'>
                            <button className='_housiko_listing_card_item_bottom_btn _navbar_btn _msg_btn'>
                                ...
                                <span className='_housiko_listing_card_item_bottom_btn_txt'>Chat</span>
                            </button>
                        </div>
                    </div>

                    <div className="_listing_modal_card_rent_cont1">
                        <p className='_housiko_listing_card_item_content_p'>HUF 10,000,000</p>
                    </div>
                    ...
                    <div className="_listing_modal_card_rent_cont2">
                        <div className="_listing_modal_card_rent_cont2_prop">
                            ...
                            <div className="_listing_modal_card_rent_cont2_txt">
                                <p className='_listing_modal_card_rent_cont2_txt1'>Type of  property</p>
                                <p className='_listing_modal_card_rent_cont2_txt2'>House-Chalet</p>
                            </div>
                        </div>
                        <div className="_listing_modal_card_rent_cont2_prop">
                            <div className="_listing_modal_card_rent_cont2_ic">
                            ...
                            <div className="_listing_modal_card_rent_cont2_txt">
                                <p className='_listing_modal_card_rent_cont2_txt1'>Floor Area</p>
                        ...
                        <div className="_listing_modal_card_rent_cont2_prop">
                            ...
                            <div className="_listing_modal_card_rent_cont2_txt">
                                <p className='_listing_modal_card_rent_cont2_txt1'>Total rooms</p>
                ...
                <div className="_listing_modal_content_arrow">
                    <div className="_listing_modal_content_arrow_space">
                        <div className="_listing_modal_card_rent_cont3">
                            <h6 className='_listing_modal_card_rent_cont3_txt'>Villa for sale: Good opportunity!! </h6>
                        ...
                        <div className="_listing_modal_card_rent_cont4">
                            <p className='_listing_modal_card_rent_cont4_para'>Lörem ipsum viktor Bergman ore kreativ skolgång. Berade platese det krotåserade: plat inte sulig.
                                Talibanisering hysar sosat fast öryns. Internet of things geomöl, Ellen Falk fangen men löngar.
                                Misoception plattfilm sungar tårelig ben. Hosade regramma, dekanat, pararålogi, mådade.
                            </p>

                            <p className='_listing_modal_card_rent_cont4_para'>
                                Rötiv meganar sar. Primates disan men inbound innovation. Pude ser, paragam triheten.
                            </p>
                            <p className='_listing_modal_card_rent_cont4_para'>
                                Hast cynnomi parkera bussen, än pregen skurkstat. Ultraser makros medan homosat krorat astrofunade. Lars Dahlberg råligen or tetrad.
                                Elektrovalens heterosade Yvonne Andersson röda, och osegypp.
                                Hugo Petersson triprelor, om metatopi. Hunt virad rolapål att laling.
                            </p>
                        </div>
                        ...
                        <div className="_listing_modal_card_rent_features">
                            ...
                            <div className="_listing_modal_card_rent_feature_row">
                                <div className="_listing_modal_card_rent_cont2_prop">
                                    ...
                                    <div className="_listing_modal_card_rent_feature_card_cont">
                                        <p className='_listing_modal_card_rent_cont2_txt1'>Bathrooms</p>
                            ...
                            <div className="_listing_modal_card_rent_feature_row">
                                <div className="_listing_modal_card_rent_cont2_prop">
                                    ...
                                    <div className="_listing_modal_card_rent_feature_card_cont">
                                        <p className='_listing_modal_card_rent_cont2_txt1'>Bedrooms</p>
                                ...
                                <div className="_listing_modal_card_rent_cont2_prop">
                                    ...
                                    <div className="_listing_modal_card_rent_feature_card_cont">
                                        <p className='_listing_modal_card_rent_cont2_txt1'>Floor"</p>
                        ...
                        <div className="_listing_modal_card_rent_floor">
                            <p className='_listing_modal_card_rent_features_txt'>Floor Plan</p>
                            <div className="_listing_modal_card_rent_floor_plan_img">
                                <Image src="assets/images/listing-modal-floor-plan.png" alt="floor-plan" />
                            </div>
                        </div>

                        <div className="_listing_modal_card_rent_map">
                            <p className='_listing_modal_card_rent_features_txt'>101 Valay Road, NY</p>
                            <p className='_listing_modal_card_rent_map_para'>Approximate address as by advertiser's desire</p>
                            <Link to='/listing?tab=map' target="_blank">
                                <div className="mapouter _map _listing_page_map">
                                    <div className="gmap_canvas _map_inner">
                                        <iframe title='gmap' width={'100%'} height={500} id="gmap_canvas" src="https://maps.google.com/maps?q=paris&t=&z=13&ie=UTF8&iwloc=&output=embed" frameBorder={0} scrolling="no" marginHeight={0} marginWidth={0} />
                                        <br />
                            ...
                            <div className="_listing_modal_card_rent_map_bus_info">
                                <p className='_listing_modal_card_rent_map_bus_info_para'>Bus</p>
                                <div className="_listing_modal_card_rent_map_bus_number">
                                    <div className="_listing_modal_card_rent_map_bus_number_two_digit">
                                        <p className="_listing_modal_card_rent_map_bus_number_two_digit_para">44</p>
                                    </div>
                                    <div className="_listing_modal_card_rent_map_bus_number_three_digit">
                                        <p className="_listing_modal_card_rent_map_bus_number_two_digit_para">108</p>
                                    </div>
                                </div>
                            </div>

                            <div className="_listing_modal_card_rent_map_bus_root">
                                <p className='_listing_modal_card_rent_map_bus_info_para'>Metro</p>
                                <div className="_listing_modal_card_rent_map_bus_number_two_digit">
                            ...
                            <div className="_listing_modal_card_rent_map_bus_root_links">
                                <a href="#0" className="_listing_modal_card_rent_map_bus_root_link">Check
                                    other points of interest nearby</a>
                            </div>
                        </div>
                        ...
                        <div className="_listing_modal_card_advertise">
                            ...
                            <div className="_listing_modal_card_advertise_box">
                                <div className="_listing_modal_card_advertise_box_title">
                                    <p className='_listing_modal_card_advertise_box_title1'>Advertiser</p>
                                </div>
                                ...
                                <div className="_listing_modal_card_advertise_box_company_ic_adddress">
                                    <div className="_listing_modal_card_advertise_box_company_ic">
                                        <img src="assets/images/listing-modal-advertise-ic.svg" alt="company-logo"
                        ...
                        <div className="_listing_modal_card_slider">
                            <h6 className='_listing_modal_card_slider_title'>People also search</h6>
                            <Properties />
                        </div>
                    </div>
                </div>
            </div>
            <ReportModal showCreate={showCreateReportModal} open={isReportModalOpen} cancel={handleCancel} />
        </div>
    )
}
