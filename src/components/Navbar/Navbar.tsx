...
import { CityModal, CreateAccount, LoginModal, MoreFilterModal, AlertModal, SaveSearch } from '../Modals/Modals';
import { FloorDropdown, PriceDropdown, ProfileDropdown, TotalRoomDropdown, TypeDropdown } from '../Dropdowns/Dropdowns';
const { Option } = Select;
...
const Navbar = () => {
    ...
    const isLoginVal = isLogin.get('isLogin');
    ...
    const isOption = getOption.get('option');
    ...
    if (location.pathname === '/listproperty') {
        return (
            <nav className="navbar navbar-expand-lg navbar-light bg-light _navbar_wrap">
                <div className="container-fluid">
                    <Link to={"/"} className="navbar-brand _navbar_logo">
                        <img src="assets/images/logo.svg" className="_navbar_logo_img" alt="logo" />
                    </Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0 _navbar_ul2">
                            <li className="nav-item">
                                <Link to="/myinfo?mytab=message" className="nav-link _navbar_btn _navbar_btn3">
                            ...
                            <li className="nav-item">
                                <Link to='/myinfo?mytab=alert' className="nav-link _navbar_btn _navbar_btn3">
                            ...
                            <li className="nav-item">
                                <Link to="/myinfo?mytab=fav" className="nav-link _navbar_btn _navbar_btn3">
                            ...
                            <li className="nav-item">
                                <Link to="/listproperty" className="nav-link _navbar_btn _myinfo_navbar_btn_list _navbar_link">List Your Property For FREE</Link>
                            </li>
                            <li className="nav-item">
                                <ProfileDropdown />
                            </li>
                ...
                <LoginModal showCreate={showCreateModal} open={isLoginModalOpen} cancel={handleCancel} />
        ...
        return (
            <>
                <nav className="navbar navbar-expand-lg navbar-light bg-light _navbar_wrap">
                    <div className="container-fluid">
                        <button onClick={() => setDrawerOpen(true)} className='_myinfo_navbar_btn'>
                        ...
                        <div className="_housiko_listing_top_filter _navbar_btn3 _housiko_listing_nav_filter">
                            <Select
                                defaultValue="Home"
                                suffixIcon={<SvgIcon iconType={'caret-down'} w={14} h={14} color={'#FFBF00'} />}
                                dropdownStyle={{
                                    width: 100
                                }}
                            >
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div className="_housiko_listing_nav_city_select_wrap">
                                <ul className="_housiko_listing_nav_city_select_ul" onClick={showCityModal}>
                            ...
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 _navbar_ul2">
                                ...
                                <li className="nav-item">
                                    <Link to="/listproperty" className="nav-link _navbar_btn _navbar_btn_list _navbar_link">List Your Property For FREE</Link>
                                </li>
                                <li className="nav-item">
                                    <button className="nav-link _navbar_btn" onClick={showLoginModal}>
                                        <span className="_navbar_btn_ic">
                                            <SvgIcon iconType={'user'} />
                                        </span>
                                        <span className="_navbar_btn_txt">
                                            Log In
                                        </span>
                                    </button>
                                </li>
                    ...
                    >
                        <div className='_housiko_drawer_ul'>
                            <div className="_housiko_drawer_ul1">
                                <div className='_housiko_drawer_li' onClick={() => changeOption('buy')}>
                                    <Link to="/listing?option=buy">
                                        Buy
                                    </Link>
                                </div>
                                <div className='_housiko_drawer_li' onClick={() => changeOption('rent')}>
                                    <Link to="/listing?option=rent">
                                        Rent
                                    </Link>
                                </div>
                                <div className='_housiko_drawer_li'>Individuals</div>
                                <div className='_housiko_drawer_li _housiko_list_prop_main_tab_come'>Professionals
                    ...
                    <ul className="_housiko_listing_nav_select_ul d-flex">
                        ...
                        <li className="_housiko_listing_nav_select_li">
                            <div className="_housiko_listing_nav_dropdown_wrap">
                                <div onClick={() => setMoreFilterModal(true)} className="_housiko_listing_nav_dropdown _nav_more_btn">
                    ...
                    <div className="_housiko_listing_nav_search_btn_wrap">
                        <ul className="_housiko_listing_nav_search_btn_ul">
                            <li className="_housiko_listing_nav_search_btn_li">
                                <button className="_housiko_listing_nav_search_btn _housiko_listing_nav_alert_btn" onClick={showCreateAlertModal}>
                            ...
                            <li className="_housiko_listing_nav_search_btn_li">
                                <button onClick={() => setSaveSearch(true)} className="_housiko_listing_nav_search_btn">
                                    <span className="_housiko_listing_nav_search_btn_txt">
                                        Save Search
                                    </span>
                                </button>
    ...
    else if (location.pathname === '/pricing' && isLoginVal) {
        return (
            <>
                <nav className="navbar navbar-expand-lg navbar-light bg-light _navbar_wrap">
                    <div className="container-fluid">
                            ...
                            <ul className="navbar-nav mb-2 mb-lg-0 _navbar_ul">
                                <li className="nav-item _navbar_pricing_li _navbar_li">
                                    <div className="_housiko_hero_content_tab_search_wrap">
                                        <Input className='_housiko_hero_content_tab_input' placeholder="find home" />
                                    </div>
                                </li>
                            </ul>
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 _navbar_ul2">
    ...
    else if (pathToAvoid.includes(location.pathname)) {
        return (
            <>
            </>
        )
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav mb-2 mb-lg-0 _navbar_ul">
                                <li className="nav-item _navbar_pricing_li _navbar_li">
                                    <div className="_housiko_hero_content_tab_search_wrap">
                                        <Input className='_housiko_hero_content_tab_input _housiko_myinfo_inpt' placeholder="find home" />
                                    </div>
                                </li>
                            </ul>
    ...
    else if (location.pathname === '/agentlist') {
        return (
            <>
                <nav className="navbar navbar-expand-lg navbar-light bg-light _navbar_wrap">
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav mb-2 mb-lg-0 _navbar_ul">
                                <li className="nav-item _navbar_li">
                                    ...
                                    <Link to="/listing?option=buy" className="nav-link _navbar_link">Buy</Link>
                                </li>
                                <li className="nav-item _navbar_li">
                                    <Link to="/listing?option=rent" className="nav-link _navbar_link">Rent</Link>
                                </li>
                                <li className="nav-item _navbar_li">
                                    <a className="nav-link _navbar_link" href="#0">Individuals</a>
                                </li>
                                <li className="nav-item _navbar_li">
                                    <a className="nav-link _navbar_link" href="#0">Professionals</a>
                                </li>
                                <li className="nav-item _navbar_li">
                                    <a className="nav-link _navbar_link" href="#0">Blog</a>
                                </li>
                                {/* <li className="nav-item _navbar_li">
