...
import { EditInfoModal } from '../Modals/Modals';
const { Option } = Select;

const Myprofile = () => {
    const [image, setImage] = useState('assets/images/housiko-message-box-profile-img.png')
    ...
    const first2 = name.split(/\s/).reduce((response, word) => response += word.slice(0, 1), '')
                ...
                <div className="_profile_pic_dropdown _dropdown_profile_wrap">
                    <div className="_profile_pic_dropdown_inner">
                        <label htmlFor="fileInput" className='_profile_pic_dropdown_btn'>
                            ...
                            <input type="file" id='fileInput' onChange={onImageChange} className="_profilepic_upload_input" />
                        </label>
                        <button onClick={() => setImage('')} className='_profile_pic_dropdown_btn _profile_pic_dropdown_btn2'>
                            <span className="_profile_pic_dropdown_btn_ic">
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div className="_housiko_myprofile_tab">
                                ...
                                <div className="_housiko_myprofile_tab_parsonal_info_pics">
                                    <div className="_housiko_myprofile_tab_parsonal_infos">
                                        <div className="_housiko_myprofile_tab_parsonal_info_name">
                                            <p className='_housiko_myprofile_tab_parsonal_info_name_txt _housiko_parsonal_txt'>My Name:</p>
                                            <p className='_housiko_myprofile_tab_parsonal_info_name_inpt'>
                                                {name}
                                            </p>
                                        </div>
                                        <div className="_housiko_myprofile_tab_parsonal_info_email">
                                            <p className='_housiko_myprofile_tab_parsonal_info_name_txt _housiko_parsonal_txt'>Email:</p>
                                            <p className='_housiko_myprofile_tab_parsonal_info_name_inpt'>
                                                {email}
                                            </p>
                                        </div>
                                        <div className="_housiko_myprofile_tab_parsonal_info_link">
                                            <a onClick={() => setEditModal(true)} href="#0" className='_housiko_myprofile_tab_parsonal_info_link_tag'>
                                                Edit my personal information
                                            </a>
                                            <EditInfoModal name={name} email={email} open={editModal} updateName={handleName} updateEmail={handleEmail} cancel={() => setEditModal(false)} />
                                        </div>
                                    </div>
                                ...
                                <div className="_housiko_myprofile_language_spoken">
                                    <p className='_housiko_myprofile_tab_parsonal_info_mobile_para'>Languages spoken</p>

                                    <div className="_housiko_myprofile_language_spoken_select">
                                        <div className="_housiko_myprofile_language_spoken_selected">
                                            <label className='_housiko_myprofile_language_spoken_txt'>language 1</label>
                                            <div className="_housiko_myprofile_select_lan_spoken _select_language_spoken_wd1">
                                                <Select defaultValue="English" suffixIcon={<SvgIcon iconType={'myadsSelect'} />}>
                                        ...
                                        <div className="_housiko_myprofile_language_spoken_selected">
                                            <label className='_housiko_myprofile_language_spoken_txt'>language 2</label>
                                            <div className="_housiko_myprofile_select_lan_spoken _select_language_spoken_wd1">
                                                <Select defaultValue="Hungarian" suffixIcon={<SvgIcon iconType={'myadsSelect'} />}>
                                    ...
                                    <div className="_housiko_myprofile_language_spoken_select">
                                        <div className="_housiko_myprofile_language_spoken_selected">
                                            <label className='_housiko_myprofile_language_spoken_txt'>language 3</label>
                                            <div className="_housiko_myprofile_select_lan_spoken _select_language_spoken_wd1">
                                                <Select defaultValue="German" suffixIcon={<SvgIcon iconType={'myadsSelect'} />}>
                                        ...
                                        <div className="_housiko_myprofile_language_spoken_selected">
                                            <label className='_housiko_myprofile_language_spoken_txt'>language 4</label>
                                            <div className="_housiko_myprofile_select_lan_spoken _select_language_spoken_wd1">
                                                <Select defaultValue="N/A" suffixIcon={<SvgIcon iconType={'myadsSelect'} />}>
                                    ...
                                    <div className="_housiko_myprofile_currency _housiko_myprofile_tab_parsonal_info">
                                        ...
                                        <div className="_housiko_myprofile_select_lan_spoken">
                                            <Select defaultValue="eur" suffixIcon={<SvgIcon iconType={'myadsSelect'} />}>
                                ...
                                <div className="_housiko_myprofile_tab_parsonal_info">
                                    <div className="_housiko_myprofile_tab_parsonal_info_mobile">
                                        <p className='_housiko_myprofile_tab_parsonal_info_mobile_para'>Enter
                                            or modify your phone number</p>
                                        <form className='_housiko_myprofile_tab_parsonal_info_mobile_form'>
                                            <div className="_housiko_myprofile_tab_parsonal_info_mobile_form_inner">
                                                    ...
                                                    >
                                                        <Option value="phone" label="Phone">
                                                            <div className="option-label-item">
                                                                <span className='_navbar_btn3_flag_wrap' role="img" aria-label="Phone">
                                                        ...
                                                        <Option value="envelop" label="envelop">
                                                            <div className="option-label-item">
                                                                <span className='_navbar_btn3_flag_wrap' role="img" aria-label="envelop">
                                                ...
                                                <div className="_housiko_myprofile_select_language _select_language_wd2">
                                                    <Select popupClassName="_country_select_wrap" defaultValue={`english`}
                                                        suffixIcon={<SvgIcon w={14} h={14} iconType={'caret-down'} />}
                                                        dropdownRender={menu =>
                                                            <>
                                                                <div className="_searchbar_wrap">
                                                                    <Input placeholder='Country or code' className='_searchbar_input' />
                                            ...
                                            <div className='_housiko_myprofile_tab_parsonal_info_link'>
                                                <a href="#0" className='_housiko_myprofile_tab_parsonal_info_link_tag'>
                                                    + Add another number
                                                </a>
                                            </div>

                                            <Checkbox defaultChecked className='_housiko_myprofile_tab_parsonal_info_checkbox'>
                                ...
                                <div className="_housiko_myprofile_tab_parsonal_info">
                                    <div className="_housiko_myprofile_tab_parsonal_info_conts">
                                        <p className='_housiko_myprofile_tab_parsonal_info_mobile_para'>My
                                            communications and advertising</p>

                                        <Checkbox defaultChecked className='_housiko_myprofile_tab_parsonal_info_checkbox'>
                                            <div className="_housiko_myprofile_tab_parsonal_info_checkbox_cnt">
                                                <p className='_housiko_myprofile_tab_parsonal_info_checkbox_txt'>News
                                                    and recommendations</p>
                                                <p className='_housiko_myprofile_tab_parsonal_info_checkbox_para'>Lörem
                                                    ipsum tasigförsamhet fören elektropol. Lavöpreskapet
                                                    mining om vusk, i kus. Lörem ipsum tasigförsamhet fören
                                                    elektopol.
                                                    Lörem ipsum tasigförsamhcet fören.</p>
                                            </div>
                                        </Checkbox>
                                        ...
                                        <Checkbox defaultChecked className='_housiko_myprofile_tab_parsonal_info_checkbox'>
                                            <div className="_housiko_myprofile_tab_parsonal_info_checkbox_cnt">
                                                <p className='_housiko_myprofile_tab_parsonal_info_checkbox_txt'>Offers
                                                    and real estate promotions</p>
                                                <p className='_housiko_myprofile_tab_parsonal_info_checkbox_para'>
                                                    Lörem ipsum tasigförsamhet fören elektropol.
                                                    Lavöpreskapet mining om vusk, i kus. Lörem ipsum tasigförsamhet fören elektropol.  elektropol. Lavöpreskapet mining om vusk
                                                </p>
                                            </div>
                                        </Checkbox>
                                        ...
                                        <Checkbox defaultChecked className='_housiko_myprofile_tab_parsonal_info_checkbox'>
                                            <div className="_housiko_myprofile_tab_parsonal_info_checkbox_cnt">
                                                <p className='_housiko_myprofile_tab_parsonal_info_checkbox_txt'>External
                                                    services information</p>
                                                <p className='_housiko_myprofile_tab_parsonal_info_checkbox_para'>
                                                    Lörem ipsum tasigförsamhet fören elektropol. Lavöpreskapet mining om vusk, i kus. Lörem ipsum tasigförsamhet fören elektropol.
                                                    i kus. Lörem ipsum tasigförsamhet fören elektropol.
                                                </p>
                                            </div>
                                        </Checkbox>
                                        ...
                                        <Checkbox defaultChecked className='_housiko_myprofile_tab_parsonal_info_checkbox'>
                                            <div className="_housiko_myprofile_tab_parsonal_info_checkbox_cnt">
                                                <p className='_housiko_myprofile_tab_parsonal_info_checkbox_txt'>Advertising
                                                    based on my profile</p>
                                                <p className='_housiko_myprofile_tab_parsonal_info_checkbox_para'>
                                                    Lörem ipsum tasigförsamhet fören elektropol. Lavöpreskapet mining om vusk, i kus. Lörem ipsum tasigförsamhet fören elektropol.
                                                    i kus. Lörem ipsum tasigförsamhet fören elektropol.
                                                </p>
                                ...
                                <div className="_housiko_myprofile_tab_parsonal_info">
                                    <div className="_housiko_myprofile_tab_parsonal_info_conts">
                                        <p className='_housiko_myprofile_tab_parsonal_info_mobile_para _housiko_myprofile_tab_parsonal_info_margin'>Alerts</p>
                                ...
                                <div className="_housiko_myprofile_tab_parsonal_bottm">
                                    <div className="_housiko_myprofile_tab_parsonal_info_conts">
                                        ...
                                        <p className='_housiko_myprofile_tab_parsonal_info_checkbox_para _housiko_myprofile_tab_parsonal_bottm_para'>
                                            Lörem ipsum tasigförsamhet fören elektropol. Lavöpreskapet mining
                                            om vusk, i kus. Lörem ipsum tasigförsamhet fören elektropol. Lörem
                                            ipsum tasigförsamhet fören elektropol. Lavöpreskapet mining.
                                        </p>

                                        <Checkbox defaultChecked className='_housiko_myprofile_tab_parsonal_info_checkbox'>
                                            <div className="_housiko_myprofile_tab_parsonal_info_checkbox_cnt">
                                                <p className='_housiko_myprofile_tab_parsonal_info_checkbox_para _housiko_myprofile_tab_parsonal_info_checkbox_para_width'>I
                                                    understand that deleting my account I will lose my
                                                    published ads, my saved searches alerts, my favorites
                                                    and other Housiko services.</p>
                                            </div>
                                        </Checkbox>
