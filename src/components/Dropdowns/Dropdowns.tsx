...
import { Checkbox, Dropdown, Input, Popover, Select } from 'antd'
...
export const TotalRoomDropdown = () => {
                            ...
                            <div className="_housiko_list_prop_characterstics_input_wrap m-0">
                                <div className="_housiko_list_prop_characterstics_input_inner">
                                    <ul className="_housiko_list_prop_tab_ul">
                                        <li onClick={() => setRoom("")} className={`_housiko_list_prop_tab_li ${room == '' ? '_active' : ''}`}>
                                            All
                                        </li>
                                        <li onClick={() => setRoom('1')} className={`_housiko_list_prop_tab_li ${room == '1' ? '_active' : ''}`}>
                                            1{!exactNum ? '+' : ''}
                                        </li>
                                        <li onClick={() => setRoom('2')} className={`_housiko_list_prop_tab_li ${room == '2' ? '_active' : ''}`}>
                                            2{!exactNum ? '+' : ''}
                                        </li>
                                        <li onClick={() => setRoom('3')} className={`_housiko_list_prop_tab_li ${room == '3' ? '_active' : ''}`}>
                                            3{!exactNum ? '+' : ''}
                                        </li>
                                        <li onClick={() => setRoom('4')} className={`_housiko_list_prop_tab_li ${room == '4' ? '_active' : ''}`}>
                                            4{!exactNum ? '+' : ''}
                                        </li>
                                    </ul>
                                </div>
                                <Checkbox onChange={() => setExactNum(!exactNum)} className='_login_input_check _city_input_check_login_input_check _login_input_label'>
                                    Exact Number
                                </Checkbox>
                            </div>
                        </div>
                        <div className="_dropdown_price_content_btn_wrap">
                            <button className="_dropdown_price_content_btn">
                                Apply
                            </button>
                        </div>
                    </div>
    ...
    return (
        <Dropdown className='_housiko_listing_nav_dropdown _housiko_listing_floor_nav_dropdown' overlay={totalRoom} trigger={['click']} >
...
export const FloorDropdown = () => {
            ...
            <>
                <div className="_dropdown_price_wrap">
                    <div className="_dropdown_price_inner">
                        ...
                        <div className="_dropdown_price_content">
                            <div className="_dropdown_price_content_input_wrap">
                                <div className="_dropdown_price_content_input_inner _housiko_listing_floor_nav_drop_inner">
                                    <label htmlFor="" className="_dropdown_price_content_input_label">Min</label>
                                ...
                                <div className="_dropdown_price_content_input_inner _housiko_listing_floor_nav_drop_inner">
                                    <label htmlFor="" className="_dropdown_price_content_input_label">Max</label>
                                    <div className="_dropdown_price_content_input_select_wrap">
                                        <Select
                                            defaultValue="Ind"
                                            className="_dropdown_price_content_input"
                        ...
                        <div className="_dropdown_price_content_btn_wrap">
                            <button onClick={getFloor} className="_dropdown_price_content_btn">
                                Apply
                            </button>
                        </div>
                    </div>
    ...
    return (
        <Dropdown className='_housiko_listing_nav_dropdown _housiko_listing_floor_nav_dropdown' overlay={floorDrop} trigger={['click']}>
            <p className="_housiko_listing_nav_dropdown_txt">
                {
                    floor.length == 0 && ('Floor Area')
                }
                {
                    floor.length != 0 && floor != 'Ind - Ind' && (floor) || floor == 'Ind - Ind' && ('Floor Area')
                }
                <span className="_housiko_listing_nav_dropdown_ic">
                    <SvgIcon iconType={'caret-down'} w={14} h={14} />
                </span>
...
export const TypeDropdown = () => {
                            ...
                            <div className="_dropdown_type_content_ul_wrap">
                                <ul className="_dropdown_type_content_ul">
                                    <li className="_dropdown_type_content_li">
                                        <Checkbox checked className='_login_input_check _city_input_check_login_input_check _login_input_label'>
    ...
    return (
        <>
            <Dropdown className='_housiko_listing_nav_dropdown' overlay={typeDrop} trigger={['click']}>
                <p className="_housiko_listing_nav_dropdown_txt">
...
export const PriceDropdown = () => {
            ...
            <>
                <div className="_dropdown_price_wrap">
                    <div className="_dropdown_price_inner">
                        ...
                        <div className="_dropdown_price_content_btn_wrap">
                            <button onClick={getPrice} className="_dropdown_price_content_btn">
                                Apply
                            </button>
                        </div>
                    </div>
    ...
    return (
        <Dropdown className='_housiko_listing_nav_dropdown' overlay={priceDrop} trigger={['click']}>
            <p className="_housiko_listing_nav_dropdown_txt">
                {
                    price.length == 0 && ('Price')
                }
                {
                    price.length != 0 && price != 'Ind - Ind' && (price) || price == 'Ind - Ind' && ('Price')
                }
                <span className="_housiko_listing_nav_dropdown_ic">
                    <SvgIcon iconType={'caret-down'} w={14} h={14} />
                </span>
                ...
                <div className="_dropdown_profile_wrap _nav_dropdown_profile_wrap">
                    <div className="_dropdown_profile_buttons border-0">
                        <div className="_dropdown_profile_button_list">
                            <button onClick={() => setIsActive(true)} className='_dropdown_profile_button'>
                        ...
                        <div className="_dropdown_profile_button_list">
                            <button onClick={() => setIsActive(false)} className='_dropdown_profile_button'>
                                <span className="_housiko_myads_btn_txt">
                                    Unvailable
                                </span>
                            </button>
...
export const ProfileDropdown = () => {
            ...
            <>
                <div className="_dropdown_profile_wrap">
                    <div className="_dropdown_profile_info">
                        ...
                        <div className="_dropdown_profile_info_btn">
                            <div className='_housiko_profile_nav_dropdown_main_plus_box'>
                                <p className='_housiko_profile_nav_dropdown_main_plus_box_cont'>Plus</p>
                            </div>
                            <Link to="/pricing?isLogin=1" className="_dropdown_profile_info_btn_link">
                                Change plan
                            </Link>
                        </div>
                    </div>
                    <div className="_dropdown_profile_buttons">
                        <div className="_dropdown_profile_button_list">
                            <Link to="/myinfo?mytab=profile" className='_dropdown_profile_button'>
                        ...
                        <div className="_dropdown_profile_button_list">
                            <Link to="/myinfo?mytab=message" className='_dropdown_profile_button'>
                        ...
                        <div className="_dropdown_profile_button_list">
                            <Link to="/myinfo?mytab=ad" className='_dropdown_profile_button'>
                                <span className='_dropdown_profile_button_ic _bg_ic1'>
                        ...
                        <div className="_dropdown_profile_button_list">
                            <button className='_dropdown_profile_button products_come'>
                                ...
                                <span className='_housiko_list_prop_main_tab_come_box'>
                                    <p className='_housiko_list_prop_main_tab_come_box_txt'>coming soon</p>
                                </span>
                            </button>
                        </div>
                        <div className="_dropdown_profile_button_list">
                            <Link to="/myinfo?mytab=alert" className='_dropdown_profile_button'>
                                <span className='_dropdown_profile_button_ic _bg_ic3'>
                        ...
                        <div className="_dropdown_profile_button_list">
                            <Link to="/myinfo?mytab=fav" className='_dropdown_profile_button'>
                        ...
                        <div className="_dropdown_profile_button_list">
                            <Link to="/myinfo?mytab=discarded" className='_dropdown_profile_button'>
                                <span className='_dropdown_profile_button_ic _bg_ic4'>
    ...
    return (
        <div className="_housiko_listing_nav_dropdown_wrap _housiko_listing_nav_select _housiko_myads_search_list_space">
            <Dropdown className='_housiko_profile_nav_dropdown' overlay={profileDrop} trigger={['click']}>
                <div className="_housiko_profile_nav_dropdown_main">
                    <div className="_housiko_profile_nav_dropdown_main_ic _active_prof">
                        <img src="assets/images/dropdown-profile-img.png" alt="icon"
...
export const FavouriteDropdown = () => {
    ...
    return (
        <div className="_housiko_listing_nav_dropdown_wrap _housiko_listing_nav_select _housiko_myads_search_list_space">
            <Dropdown className='_housiko_profile_nav_dropdown' overlay={favDrop} trigger={['click']}>
                <button className="_housiko_listing_card_item_bottom_btn">
                    <span className={`_housiko_listing_card_item_bottom_btn_ic ${fav ? '_active' : ''}`}>
...
export const PrintDropdown = () => {
    ...
    return (
        <div className="_housiko_myads_qr_code_btn_wrap">
            <Dropdown className='_housiko_profile_nav_dropdown' overlay={printDrop} trigger={['click']}>
...
export const ExtraPopover = () => {
                ...
                <div className="_extra_popver_ul_wrap _housiko_listing_nav_tag_wrap">
                    <ul className="_extra_popver_ul _housiko_listing_nav_tag_ul">
                        <li className="_housiko_listing_nav_tag_li">
                            <span className="_housiko_listing_nav_tag_li_txt">
                                Airbnb
                            </span>
                        </li>
                        <li className="_housiko_listing_nav_tag_li">
    ...
    return (
        <>
            <Popover overlayClassName='_popover_wrap' title={null} content={popoverContent} placement={'bottom'} trigger="hover">
                <p className="_housiko_listing_card_item_tag_txt">
                    16+ Extras
                </p>
            </Popover>
        </>
