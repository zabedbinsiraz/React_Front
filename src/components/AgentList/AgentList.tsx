                            ...
                            <div className="col-xl-12 col-lg-12 col-md-12">
                                ...
                                <div className="_housiko_agentlist_search_select">
                                    <div className='_housiko_agentlist_search'>
                                        <input type="text" placeholder='Search' className='_housiko_agentlist_search_inpt' />
                                        <button className='_housiko_agentlist_search_btn'>
                                            <SvgIcon iconType={'search1'} w={24} h={24} color={'#252E8D'} />
                                        </button>
                                    </div>
                                            ...
                                            <div className="_housiko_agentlist_card">
                                                <div className="_housiko_agentlist_card_ic_address">
                                                    ...
                                                    <div className="_housiko_agentlist_card_property">
                                                        <p className='_housiko_agentlist_card_property_para'>54 Properties</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="_listing_modal_card_advertise_box_chat">
                                                    <div className="_housiko_agentlist_card_button_link">
                                                            ...
                                                            <div className="_listing_modal_card_advertise_box_rating">
                                                                <ul className='_listing_modal_card_advertise_box_rating_list'>
                                                                    <li className='_listing_modal_card_advertise_box_rating_ic'>
                                                                        <SvgIcon iconType={'star'} w={18} h={18} color={'#FFBF00'} />
                                                                    </li>
                                                                    <li className='_listing_modal_card_advertise_box_rating_ic'>
                                                                        <SvgIcon iconType={'star'} w={18} h={18} color={'#FFBF00'} />
                                                                    </li>
                                                                    ...
                                                                    <li className='_listing_modal_card_advertise_box_rating_ic'>
                                                                        <SvgIcon iconType={'star1'} w={18} h={18} color={'#FFBF00'} />
                                                                    </li>
                                                        ...
                                                        <div className="_housiko_agentlist_card_link">
                                                            <Link to='/listing' className='_housiko_agentlist_card_link_tag'>
                                                                See All Properties
                                                            </Link>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className='_housiko_myfav_pagination_wrap'>
                                                <ul className='_housiko_listing_item_pagination_ul'>
                                                    <li className='_housiko_listing_item_pagination_li'>
                                                        <button className='_housiko_listing_item_pagination_btn _active'>1</button>
                                                    </li>
                                                    <li className='_housiko_listing_item_pagination_li'>
                                                        <button className='_housiko_listing_item_pagination_btn'>2</button>
                                                    </li>
                                                    <li className='_housiko_listing_item_pagination_li'>
                                                        <button className='_housiko_listing_item_pagination_btn'>3</button>
                                                    </li>
                                                    <li className='_housiko_listing_item_pagination_li'>
                                                        <button className='_housiko_listing_item_pagination_btn'>4</button>
                                                    </li>
                                                    <li className='_housiko_listing_item_pagination_li'>
                                                        <button className='_housiko_listing_item_pagination_btn'>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 18 18"><path fill="#252E8D" d="m11.25 9 .707.707.707-.707-.707-.707L11.25 9Zm-3.793 5.207 4.5-4.5-1.414-1.414-4.5 4.5 1.414 1.414Zm4.5-5.914-4.5-4.5-1.414 1.414 4.5 4.5 1.414-1.414Z"></path></svg>
                                                        </button>
                                                    </li>
                                                </ul>
                                            </div>
