                   ...
                   <div className="_housiko_myads_search">
                       <div className="_housiko_myads_search_select_list">
                           <div className="_housiko_myads_search _housiko_myads_search_list_space">
                               <Input className='_housiko_myads_search_inpt' placeholder="Search by reference" prefix={<SvgIcon iconType={'myadsSearch'}/>} />
                           </div>
                           <div className="_housiko_myads_select _housiko_myads_select_wd1 _housiko_myads_search_list_space">
                               <Select defaultValue="Price" suffixIcon={<SvgIcon iconType={'myadsSelect'}/>}>
                           ...
                           <div className="_housiko_myads_select _housiko_myads_select_wd2 _housiko_myads_search_list_space">
                               <Select defaultValue="Floor Area" suffixIcon={<SvgIcon iconType={'myadsSelect'}/>}>
                           ...
                           <div className="_housiko_myads_select _housiko_myads_select_wd3 _housiko_myads_search_list_space">
                               <Select defaultValue="Total Rooms" suffixIcon={<SvgIcon iconType={'myadsSelect'}/>}>
                       ...
                       <div className="_housiko_myproduct_search_balance">
                           <p className='_housiko_myproduct_search_balance_txt1'>Housikoin balance</p>
                           <p className='_housiko_myproduct_search_balance_txt2'> $40,000</p>
                       </div>
                   </div>
               </div>
           </div>
                   ...
                   <div className="_housiko_myproduct_left_cards">
                       <div className="_housiko_myproduct_left_card_head">
                           ...
                           <div className="_housiko_listing_top_filter_wrap">
                               <p className="_housiko_listing_top_filter_txt">
                                   Sort by: 
                               </p>
                       ...
                       <div className="_housiko_myproduct_left_card">
                           <div className="_housiko_myproduct_left_card_img">
                               <img src="assets/images/myproduct-card-img.png" alt="myproduct-card" className='_housiko_myproduct_left_card_img_tag' />
                           </div>
               ...
               <div className="col-xl-6 col-lg-7 col-md-12 col-sm-12 me-auto">
                   <div className="_housiko_myproduct_r8_cards">
                       <div className="_housiko_myproduct_r8_card">
                           <div className="_housiko_myproduct_r8_card_txt">
                               <span className='_housiko_myproduct_r8_card_txt_sp'>
                                   <img src="assets/images/my-product-carbon-rocket.svg" alt="iocn" className='_housiko_myproduct_r8_card_txt_icon'/>
                               </span>
                               <p className='_housiko_myproduct_r8_card_txt1'>UPs
                                   <span className='_housiko_myproduct_r8_card_txt1_sp'>
                                       <SvgIcon iconType={'info'} w={15} h={15} color={'#252E8D'} />
                                   </span>
                               </p>
                           </div>    
                       ...
                       <div className="_housiko_myproduct_r8_card">
                           <div className="_housiko_myproduct_r8_card_txt">
                               <span className='_housiko_myproduct_r8_card_txt_sp'>
                                   <img src="assets/images/my-product-top-ic.svg" alt="iocn" className='_housiko_myproduct_r8_card_txt_icon'/>
                               </span>
                               <p className='_housiko_myproduct_r8_card_txt1'>Top
                                   <span className='_housiko_myproduct_r8_card_txt1_sp'>
                                       <SvgIcon iconType={'info'} w={15} h={15} color={'#252E8D'} />
                                   </span>
                               </p>
                           ...
                           <div className="_housiko_myproduct_r8_card_box _housiko_myproduct_r8_card_box_width2">
                               ...
                               <a href="#0" className='_housiko_myproduct_left_card_cont_link'>Renew</a>
                           </div>                
                       </div>
                       <div className="_housiko_myproduct_r8_card">
                           <div className="_housiko_myproduct_r8_card_txt">
                               <span className='_housiko_myproduct_r8_card_txt_sp'>
                                   <img src="assets/images/my-product-promo-ic.svg" alt="iocn" className='_housiko_myproduct_r8_card_txt_icon'/>
                               </span>
                               <p className='_housiko_myproduct_r8_card_txt1'>Promo
                                   <span className='_housiko_myproduct_r8_card_txt1_sp'>
                                       <SvgIcon iconType={'info'} w={15} h={15} color={'#252E8D'} />
                                   </span>
                               </p>
                       ...
                       <div className="_housiko_myproduct_r8_card">
                           <div className="_housiko_myproduct_r8_card_txt">
                               <span className='_housiko_myproduct_r8_card_txt_sp'>
                                   <SvgIcon iconType={'envelop'} w={16} h={16} color={'#000'} />
                               </span>
                               <p className='_housiko_myproduct_r8_card_txt1'>Alert
                                   <span className='_housiko_myproduct_r8_card_txt1_sp'>
                                       <SvgIcon iconType={'info'} w={15} h={15} color={'#252E8D'} />
                                   </span>
                               </p>
                           ...
                           <div className="_housiko_myproduct_r8_card_box _housiko_myproduct_r8_card_box_width3">
                               <Switch className='_housiko_list_prop_toggle_btn myproduct_toggle' />
                               <p className='_housiko_list_prop_para'>7 days left</p>
                               <a href="#0" className='_housiko_myproduct_left_card_buy_link'>
                                   Buy
                               </a>
                           </div>                
                       </div>
                       ...
                       <div className="_housiko_myproduct_r8_card">
                           ...
                           <div className="_housiko_myproduct_r8_card_box _housiko_myproduct_r8_card_box_width1">
                               <span className='_housiko_myproduct_r8_card_box_select _housiko_myproduct_r8_card_box_select_width1'>
                                   <Select defaultValue="3D Tour" suffixIcon={<SvgIcon iconType={'myadsSelect'}/>}>
                       ...
                       <div className="_housiko_myproduct_r8_card">
                           ...
                           <div className="_housiko_myproduct_r8_card_box _housiko_myproduct_r8_card_box_width4">
                               <span className='_housiko_myproduct_r8_card_box_select _housiko_myproduct_r8_card_box_select_width2'>
                                   <Select defaultValue="Great location" suffixIcon={<SvgIcon iconType={'myadsSelect'}/>}>
                               ...
                               <a href="#0" className='_housiko_myproduct_left_card_cont_preview_link'>Preview</a>
                           </div>                
                       </div>
                       <div className="_housiko_myproduct_r8_card">
                           <div className="_housiko_myproduct_r8_card_txt">
