...
import { PricingPlanExample } from '../Modals/Modals';
...
const Pricing = ({ name }: any) => {
    ...
    return (
        <>
                        ...
                        <div className="row">
                            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div className="_housiko_pricing_header_wrap">
                                    {
                                        !isLoginVal && (
                                            <Link to="/" className="_housiko_pricing_header_img_wrap d-block">
                                                <img src="assets/images/logo.svg" alt="housiko logo" className="_housiko_pricing_header_img" />
                                            </Link>
                                        )
                                    }
                                    {
                                    ...
                                    <div className="_housiko_pricing_header_txt">
                                        {
                                            isLoginVal && (
                                                <h2 className="_housiko_pricing_header_title">Your Plan</h2>
                                            )
                                        }
                                        {
                                            !isLoginVal && (
                                                <h2 className="_housiko_pricing_header_title">Choose your plan</h2>
                                            )
                                        }
                                    </div>
                                </div>
                                                ...
                                                <div className="_housiko_pricing_content_inner">
                                                    <div className="_housiko_pricing_content_inner_top">
                                                        <div className="_housiko_pricing_content_top">
                                                            <h3 className="_housiko_pricing_content_top_title">Free</h3>
                                                        </div>
                                                        <div className="_housiko_pricing_content_txt">
                                                            <h2 className="_housiko_pricing_content_title">Free</h2>
                                                        </div>
                                                    ...
                                                    <div className="_housiko_pricing_content_inner_bottom">
                                                        <div className="_housiko_pricing_content_btn_wrap">
                                                            {
                                                                !isLoginVal && (
                                                                    <Link to="/myinfo?mytab=myprofile" className="_housiko_pricing_content_btn">
                                                                        Get started
                                                                    </Link>
                                                                )
                                                            }
                                                            ...
                                                            <button onClick={() => handlePlan('free')} className="_housiko_pricing_content_btn _housiko_pricing_content_btn2">
                                                                See example
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                                            <div className="_housiko_pricing_content">
                                                <div className="_housiko_pricing_content_inner">
                                                    <div className="_housiko_pricing_content_inner_top">
                                                        <div className="_housiko_pricing_content_top">
                                                            <h3 className="_housiko_pricing_content_top_title">Plus</h3>
                                                        </div>
                                                        <div className="_housiko_pricing_content_txt">
                                                            <h2 className="_housiko_pricing_content_title">HUF 3,500<span>/month</span></h2>
                                                        </div>
                                                        <div className="_housiko_pricing_content_ul_wrap">
                                                            <ul className="_housiko_pricing_content_ul">
                                                                <li className="_housiko_pricing_content_li">
                                                                ...
                                                                <li className="_housiko_pricing_content_li">
                                                                    ...
                                                                    <span className="_housiko_pricing_content_li_txt">
                                                                        Bigger pictures and more data displayed than free
                                                                    </span>
                                                                </li>
                                                                <li className="_housiko_pricing_content_li">
                                                                    <span className="_housiko_pricing_content_li_ic">
                                                    ...
                                                    <div className="_housiko_pricing_content_inner_bottom">
                                                        <div className="_housiko_pricing_content_btn_wrap">
                                                            {
                                                                !isLoginVal && (
                                                                    <Link to="/myinfo?mytab=profile" className="_housiko_pricing_content_btn">
                                                                        Get started
                                                                    </Link>
                                                                )
                                                            }
                                                            ...
                                                            <button onClick={() => handlePlan('pro')} className="_housiko_pricing_content_btn _housiko_pricing_content_btn2">
                                                                See example
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                                            <div className="_housiko_pricing_content">
                                                <div className="_housiko_pricing_content_inner">
                                                    <div className="_housiko_pricing_content_inner_top">
                                                        <div className="_housiko_pricing_content_top">
                                                            <h3 className="_housiko_pricing_content_top_title">Pro</h3>
                                                        </div>
                                                        <div className="_housiko_pricing_content_txt">
                                                            <h2 className="_housiko_pricing_content_title">HUF 7,500
                                                                <span>
                                                                    /month
                                                                </span>
                                                            </h2>
                                                    ...
                                                    <div className="_housiko_pricing_content_inner_bottom">
                                                        <div className="_housiko_pricing_content_btn_wrap">
                                                            ...
                                                            <button onClick={() => handlePlan('plus')} className="_housiko_pricing_content_btn _housiko_pricing_content_btn2">
                                                                See example
                                                            </button>
                                                        </div>
                                                    </div>
            ...
            <PricingPlanExample open={pricingExample} cancel={handleCancel} plan={selectPlan} />
        </>
    )
}
