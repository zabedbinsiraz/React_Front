...
function MyAlert() {
    ...
    return (
        <div className='_housiko_myads_search_wrapper'>
                    ...
                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div className="_housiko_myalerts_card_wrap">
                            <div className="_housiko_myalerts_card_top">
                                ...
                                <button className="_housiko_listing_nav_search_btn _housiko_listing_nav_alert_btn" onClick={() => setAlertModalOpen(true)}>
                        ...
                        <div className="_housiko_myalerts_card">
                            ...
                            <div className="_housiko_myalerts_card_bottm_cont_links">
                                <div className="_housiko_myalerts_card_bottm_lft_cont">
                                    <p className='_housiko_myalerts_card_bottm_lft_cont1'>You are receving updates:</p>
                                    <p className='_housiko_myalerts_card_bottm_lft_cont2'>Instantly to your e-mail and mobile</p>
                                </div>
                                <div className="_housiko_myalerts_card_bottm_left_link">
                                    <a href="#0" className='_housiko_myalerts_card_bottm_cont_link1'>
                                        Change Frequency
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="_housiko_myalerts_card_bottm_crud_links">
                                <div className="_housiko_myalerts_card_bottm_crud_link">
                                    <a href="#0" className='_housiko_myalerts_card_bottm_crud_link1'>
                                        See result
                                    </a>
                                </div>
                                <div className="_housiko_myalerts_card_bottm_crud_link">
                                    <a href="#0" className='_housiko_myalerts_card_bottm_crud_link2'>
                                        <SvgIcon iconType={'advert'} />
                                    </a>
                                </div>
                                <div className="_housiko_myalerts_card_bottm_crud_link">
                                    <a href="#0" className='_housiko_myalerts_card_bottm_crud_link3'>
            ...
            <AlertModal open={isAlertModalOpen} cancel={() => setAlertModalOpen(false)} />
        </div>
    )
}
