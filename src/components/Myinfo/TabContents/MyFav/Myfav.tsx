...
import { ListingCarouselMany, ListingCarouselOne } from "../../../Listing/ListingCarousel";
import { FavouriteDropdown } from "../../../Dropdowns/Dropdowns"
import { CreateNewAlbum } from "../../../Modals/Modals";
            ...
            <div className="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
              <div className="_housiko_myfav_page_wrap">
                ...
                <div className="_housiko_myfav_page_album_title _housiko_myads_title_wrap mb-3">
                  <h3 className="_housiko_myfav_page_title1 mb-3">My Albums </h3>
                  <div className="_housiko_myads_add_porperty_btn_wrap">
                    <button onClick={() => setAlbumModal(true)} className="_housiko_myads_add_porperty_btn _navbar_btn">
                      + Create New Album
                    </button>
                    <CreateNewAlbum open={albumModal} cancel={() => setAlbumModal(false)} />
                  </div>
                </div>
