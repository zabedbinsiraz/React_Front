...
import { PriceDropdown, FloorDropdown, TotalRoomDropdown, PrintDropdown, ExtraPopover } from '../../../Dropdowns/Dropdowns';
            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div className="_housiko_myads_search_select_list_wrap mb-3 d-flex align-items-center justify-content-between">
                        </div>
                                    ...
                                    <div className="_housiko_listing_card_item _housiko_listing_card_item_gray">
                                        ...
                                        <div className="_housiko_listing_card_item_content">
                                            <div className="_housiko_listing_card_item_content_top">
                                                ...
                                                <img src="assets/images/myads-card-txt-ic.svg" alt="logo-card" className="_housiko_listing_card_item_content_img_logo1" />
                                            </div>
                                                ...
                                                <div className="_housiko_listing_card_item_content_txt">
                                                    <span className="_housiko_listing_card_item_content_txt_inner myads_inner_txt">
                                                        ...
                                                        <span className='_housiko_myfav_card_item_content_txt_inner'>
                                                            ...
                                                            <p className='_housiko_myfav_card_item_content_txt_inner_para'>Share</p>
                                                        </span>
                                                    </span>
                                                    ...
                                                    <div className="_housiko_listing_card_item_desc_wrap">
                                                        <p className="_housiko_listing_card_item_desc_txt">
                                                            ...
                                                            Lavöpreskapet mining om vusk, i kus. Lörem ipsum tasigförsamhet.
                                                        </p>
                                                    </div>
                                    ...
                                    <div className="_housiko_myads_card_center">
                                        <div className="_housiko_myads_card_center_links">
                                            <button className="_housiko_myads_card_center_link_list">
                                                <SvgIcon iconType={'share'} />
                                                <span className='_housiko_myads_card_center_link_list_para'>Share</span>
                                            </button>
                                            <button className="_housiko_myads_card_center_link_list">
                                                <SvgIcon iconType={'edit'} />
                                                <span className='_housiko_myads_card_center_link_list_para'>Edit</span>
                                            </button>
                                            <button className="_housiko_myads_card_center_link_list">
                                                <SvgIcon iconType={'trash'} w={16} h={17} color={'#555'} />
                                                <span className='_housiko_myads_card_center_link_list_para'>Remove property</span>
                                            </button>
                                            <div className="_housiko_myads_card_center_link_list">
                                                <span className='_housiko_myads_card_center_link_list_para1'>Reference: 56248</span>
                                            </div>
                                            <div className="_housiko_myads_card_center_link_list">
                                                <span className='_housiko_myads_card_center_link_list_para'>Date Posted : 17/09/22</span>
                                            </div>
                                        </div>
